        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[calc(100%-2rem)] max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl border border-border bg-popover shadow-2xl"
            >
              {/* Header */}
